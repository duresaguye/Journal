...
import { StackNavigationProp } from '@react-navigation/stack'; // Import the right navigation prop type

type RootStackParamList = {
  Home: undefined;
  Entry: { entry: any }; // Replace 'any' with the appropriate type for an entry
};
