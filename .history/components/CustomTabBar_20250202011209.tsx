...
const CustomTabBar: React.FC<BottomTabBarProps> = ({ state, descriptors, navigation }) => {
  ...
  return (
    <View style={styles.tabBar}>
      ...
      {/* Floating + Button Above Library Icon */}
...
const styles = StyleSheet.create({
  ...
  addButtonContainer: {
    position: 'absolute',
    bottom: 60, // Moves it above the Library icon
    left: '66%', // Positions it near the Library icon
    transform: [{ translateX: -30 }], // Adjusts horizontal alignment
    zIndex: 10,
  },
  addButton: {
    width: 60,
