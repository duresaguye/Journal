...
const CustomTabBar: React.FC<BottomTabBarProps> = ({ state, descriptors, navigation }) => {
  ...
  return (
    <StyledView className="absolute bottom-0 left-0 right-0 flex-row h-16 bg-gray-800 border-t border-gray-100 items-center justify-around shadow-md">
      ...
      <Animated.View style={{ transform: [{ scale: scaleValue }] }} className="absolute bottom-20 right-5 z-10">
        <StyledTouchableOpacity
          ...
          className="w-16 h-16 bg-orange-500 rounded-full items-center justify-center shadow-lg"
        >
